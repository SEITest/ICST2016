...
# do linear regression on y ~ x2,x3,x4,x5,x6,x7, lnx2~lnx8,neginvx2~neginvx8
# i.e. column 4~9 10~15 16~21, get adjR^2
...
for (i in 1:5)     
{
	...
	x = t(x)
	write.csv(x, "experimentResult/tableIVM1.csv", TRUE)
	start = end + 1
	end = end + d1[1,i+2]
}
